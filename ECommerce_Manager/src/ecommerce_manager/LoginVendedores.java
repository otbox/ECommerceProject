...
public class LoginVendedores extends javax.swing.JFrame {
    ...
    private void Incluir(){
        String a2 = jTextField1.getText() , a3 = jTextField2.getText();               
        try {
            if((!a2.equals(""))&&(!a3.equals(""))){ 
            ConexaoMYSQL.ConectarMYSQL();
            String sql;
            sql = "INSERT INTO `vendedores`( `Nome`, `Senha`)"
                    + "VALUES ('"+a2+"','" + a3+"')";
            ...
            UI.incluido();    
                ...
                UI.TextErro("Coloque um valor para nome ou senha");
            }
        }
        ...
        try{
            if(ID.equals("")){
             UI.erroD("Nome");
                ...
                if (opc == 0){
                    ConexaoMYSQL.ConectarMYSQL();
                    sql = "DELETE FROM vendedores WHERE Nome = '" + ID +"'";
                    Statement stm = con.prepareStatement(sql);
                    stm.execute(sql); 
                    Limpar();
                    UI.excluido();
